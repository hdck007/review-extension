...
chrome.storage.local.get(['rooms'], async result => {
  if (JSON.stringify(result) === '{}') {
    await fetch('https://review-backend-production.up.railway.app/room/create', {
      method: 'POST',
      headers: {
...
/******/ 		}
/******/ 		
/******/ 		self["webpackHotUpdatereview"] = (chunkId, moreModules, runtime) => {
